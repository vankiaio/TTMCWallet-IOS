...
- (WKWebView *)webView{
    if (!_webView) {
        ...
        if (@available(iOS 9.0, *)) {
            self.webView.customUserAgent = @"PocketTtmcIos"; //tokenpocket
        } else {
            // Fallback on earlier versions
        }
    }
...
-(void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message{
    ...
    if ([result[0] containsString:@"pair"]) {
        ...
        if ([result1_tojsonStr containsString:@"identityFromPermissions"] || [result1_tojsonStr containsString:@"authenticate"]
            ...
            [resultDict setObject:@"PocketTTMC" forKey:@"name"];
            ...
            [accountDict setObject:@"ttmc" forKey:@"blockchain"];
...
- (void)loadWebView{
    //https://dapp.newdex.io/    https://game.wizards.one/#/ https://app.dttmcgames.com/en/slots/dttmc  https://pixelmaster.io/ https://www.xpet.io/
    NSString *requestStr;
