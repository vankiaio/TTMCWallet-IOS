...
- (void)configHeaderView{
    self.headerView.assestsNameLabel.text =  IsNilOrNull(self.currentToken) ? SymbolName_TTMC : self.currentToken.token_symbol;
    self.headerView.contractNameLabel.text = [NSString stringWithFormat:@"(%@)", IsNilOrNull(self.currentToken) ? ContractName_TTMCIOTOKEN : self.currentToken.contract_name];
}
