...
- (void)getRate{
    WS(weakSelf);
    if ([self.redPacketModel.coin isEqualToString:SymbolName_TTMC]) {
        self.transferService.getRateRequest.coinmarket_id = @"ttmc";
    }else if ([self.redPacketModel.coin isEqualToString:SymbolName_OCT]){
        self.transferService.getRateRequest.coinmarket_id = @"ttmcchain";
    }else if ([self.redPacketModel.coin isEqualToString:SymbolName_CET]){
        self.transferService.getRateRequest.coinmarket_id = @"cet_ttmc";
    }
