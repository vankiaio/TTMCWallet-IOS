...
@interface TtmcPrivateKey()

@end


@implementation TtmcPrivateKey
...
- (instancetype)initTtmcPrivateKey
{
    ...
    if (self) {
        ...
        self.ttmcPrivateKey = [NSString stringWithUTF8String:base];
        ...
        b58enc(base, &len, result,37);
        self.ttmcPublicKey = [NSString stringWithFormat:@"TTMC%@", [NSString stringWithUTF8String:base]];
    }
    return self;
}
