...
@property(nonatomic , strong) Get_pocketttmc_info_request *get_pocketttmc_info_request;
@end
...
- (Get_pocketttmc_info_request *)get_pocketttmc_info_request{
    if (!_get_pocketttmc_info_request) {
        _get_pocketttmc_info_request = [[Get_pocketttmc_info_request alloc] init];
    }
    return _get_pocketttmc_info_request;
}
...
- (void)buildDataSource{
    WS(weakSelf);
    [self.get_pocketttmc_info_request getDataSusscess:^(id DAO, id data) {
        Get_pocketttmc_info_Result *result = [Get_pocketttmc_info_Result mj_objectWithKeyValues:data];
