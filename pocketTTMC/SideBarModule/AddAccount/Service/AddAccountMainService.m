...
//    NSMutableArray *itemDetailArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"使用已有的TTMC账号", nil), NSLocalizedString(@"支付费用创建新TTMC账号", nil), NSLocalizedString(@"填写注册码免费创建TTMC账号", nil), NSLocalizedString(@"不定期开放，敬请关注", nil), nil];
...
//    NSMutableArray *iconArr_BB = [NSMutableArray arrayWithObjects:@"import_account", @"pay_create_account", @"vip_create_account", @"free_create_account",nil];
    NSMutableArray *itemArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"导入账号", nil), NSLocalizedString(@"创建账号", nil), nil];
    NSMutableArray *itemDetailArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"使用已有的TTMC账号", nil), NSLocalizedString(@"创建自定义名称的TTMC账号", nil), nil];
    NSMutableArray *iconArr = [NSMutableArray arrayWithObjects:@"import_account", @"free_create_account",nil];
    NSMutableArray *iconArr_BB = [NSMutableArray arrayWithObjects:@"import_account", @"free_create_account",nil];
