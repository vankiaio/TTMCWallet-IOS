...
- (void)requestTransactionHistory{
    ...
    self.mainService.getTransactionRecordsRequest.symbols = [NSMutableArray arrayWithObjects:@{@"symbolName":@"TTMC"  , @"contractName": ContractName_TTMCIOTOKEN }, @{@"symbolName":@"OCT"  , @"contractName": ContractName_OCTOTHEMOON },nil];
    [self loadNewData];
}
