...
//    TtmcPrivateKey *activePrivateKey = [[TtmcPrivateKey alloc] initTtmcPrivateKey];
    TtmcPrivateKey *activePrivateKey = ownerPrivateKey;
    if (LEETHEME_CURRENTTHEME_IS_SOCAIL_MODE) {
        weakSelf.createAccountService.createTTMCAccountRequest.uid = CURRENT_WALLET_UID;
    }else if (LEETHEME_CURRENTTHEME_IS_BLACKBOX_MODE){
        weakSelf.createAccountService.createTTMCAccountRequest.uid = @"6f1a8e0eb24afb7ddc829f96f9f74e9d";
    }
    weakSelf.createAccountService.createTTMCAccountRequest.ttmcAccountName = weakSelf.headerView.accountNameTF.text;
    weakSelf.createAccountService.createTTMCAccountRequest.ownerKey = ownerPrivateKey.ttmcPublicKey;
    weakSelf.createAccountService.createTTMCAccountRequest.activeKey = activePrivateKey.ttmcPublicKey;
    ...
    [weakSelf.createAccountService createTTMCAccount:^(id service, BOOL isSuccess) {
