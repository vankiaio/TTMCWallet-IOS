...
- (void)createPublicKeys{
    ...
    active_public_key_from_local = [TTMC_Key_Encode ttmc_publicKey_with_wif:self.headerView.private_activeKey_tf.text];
    owner_public_key_from_local = [TTMC_Key_Encode ttmc_publicKey_with_wif:self.headerView.private_ownerKey_TF.text];
    // 请求该账号的公钥
    WS(weakSelf);
