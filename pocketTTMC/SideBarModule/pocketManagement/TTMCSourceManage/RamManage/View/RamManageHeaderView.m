...
- (void)changeActionBaseViewLabelTap:(UITapGestureRecognizer *)sender{
    ...
    if (sender.view.tag == 1000) {
        ...
        self.ttmcAmountTF.placeholder = NSLocalizedString(@"输入TTMC数量", nil);
        self.ramAmountUnitLabel.text = @"TTMC";
        ...
        self.ttmcAmountTF.placeholder = NSLocalizedString(@"输入RAM数量", nil);
