//
//  TTMCResourceManageViewController.m
//  pocketTTMC
//
...
@interface TTMCResourceManageViewController ()<PageSegmentViewDelegate, UINavigationControllerDelegate, CommonDialogHasTitleViewDelegate>
@property(nonatomic, strong) NavigationView *navView;
@property(nonatomic , strong) TTMCResourceService *mainService;
...
@implementation TTMCResourceManageViewController
...
- (TTMCResourceService *)mainService{
    if (!_mainService) {
        _mainService = [[TTMCResourceService alloc] init];
    }
    return _mainService;
}
...
- (void)buildDataSource{
    ...
    [self.mainService get_account:^(TTMCResourceResult *result, BOOL isSuccess) {
        if (isSuccess) {
...
- (void)commonDialogHasTitleViewConfirmBtnDidClick:(UIButton *)sender{
    ...
    model.dappUrl = [NSString stringWithFormat:@"https://cpuemergency.com/embed_ttmcchain.html"];
